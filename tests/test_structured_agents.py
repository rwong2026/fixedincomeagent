...
from fixedincomeagent.agents.analysts.sentiment_analyst import create_sentiment_analyst
...
def test_invoke_structured_falls_back_when_result_is_none():
    ...
    from fixedincomeagent.agents.utils.structured import invoke_structured_or_freetext

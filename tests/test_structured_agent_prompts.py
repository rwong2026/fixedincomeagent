...
import fixedincomeagent.agents.analysts.sentiment_analyst as sentiment
from fixedincomeagent.agents.managers.portfolio_manager import create_portfolio_manager
from fixedincomeagent.agents.managers.research_manager import create_research_manager
from fixedincomeagent.agents.trader.trader import create_trader
from fixedincomeagent.agents.utils.structured import NO_EXTERNAL_TOOLS
...
def test_trader_prompt_states_constraint():
    from fixedincomeagent.agents.schemas import TraderAction, TraderProposal
...
def test_research_manager_prompt_states_constraint():
    from fixedincomeagent.agents.schemas import PortfolioRating, ResearchPlan
...
def test_sentiment_prompt_states_constraint(monkeypatch):
    from fixedincomeagent.agents.schemas import SentimentBand, SentimentReport
...
def test_tool_using_analysts_keep_their_date_guidance():
    ...
    import fixedincomeagent.agents.analysts.market_analyst as market
    import fixedincomeagent.agents.analysts.news_analyst as news

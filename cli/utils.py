...
from fixedincomeagent.llm_clients.api_key_env import get_api_key_env
from fixedincomeagent.llm_clients.model_catalog import get_model_options
...
def resolve_backend_url(
    ...
    An explicit env override (``env_url``, from ``FIXEDINCOMEAGENT_LLM_BACKEND_URL``
...
def ensure_api_key(provider: str) -> str | None:
    ...
    from fixedincomeagent.llm_clients.openai_client import OPENAI_COMPATIBLE_PROVIDERS

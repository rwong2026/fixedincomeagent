# FixedIncomeAgent/graph/trading_graph.py
...
class TradingAgentsGraph:
    ...
    def _get_provider_kwargs(self) -> dict[str, Any]:
        ...
        # float() here so a value coming from a FIXEDINCOMEAGENT_TEMPERATURE env
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock"):
        ...
        ``fixedincomeagent.agents.utils.rating.is_review`` before mapping it to the
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "FixedIncomeAgentStrategy_logs"

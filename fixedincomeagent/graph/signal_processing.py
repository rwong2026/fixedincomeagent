...
header (see :func:`fixedincomeagent.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`fixedincomeagent.agents.utils.rating` is more
...
from fixedincomeagent.agents.utils.rating import RATING_REVIEW, extract_rating
...
class SignalProcessor:
    ...
    def process_signal(self, full_signal: str) -> str:
        ...
        5-tier enum should guard with :func:`~fixedincomeagent.agents.utils.rating.is_review`.
        """

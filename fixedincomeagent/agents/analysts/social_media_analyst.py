...
from fixedincomeagent.agents.analysts.sentiment_analyst import (  # noqa: F401
    create_sentiment_analyst,
    create_social_media_analyst,
)

_warnings.warn(
    "fixedincomeagent.agents.analysts.social_media_analyst is deprecated. "
    "Import from fixedincomeagent.agents.analysts.sentiment_analyst instead.",
    DeprecationWarning,
    stacklevel=2,
)

...
from fixedincomeagent.agents.utils.macro_data_tools import get_macro_indicators
from fixedincomeagent.agents.utils.market_data_validation_tools import get_verified_market_snapshot
from fixedincomeagent.agents.utils.news_data_tools import (
    get_global_news,
    get_insider_transactions,
    get_news,
)
from fixedincomeagent.agents.utils.prediction_markets_tools import get_prediction_markets
from fixedincomeagent.agents.utils.technical_indicators_tools import get_indicators
...
def resolve_instrument_identity(ticker: str) -> dict:
    ...
    """
    from fixedincomeagent.dataflows.symbol_utils import normalize_symbol
